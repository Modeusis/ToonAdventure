...
Леклер вернулся домой после долгого сезона. Тишина казалась подозрительной.
#speaker:storytelller
...
#speaker:leo
Вуф! (убегает на балкон и исчезает за поворотом)
-> END
...
=== level2_adam_dialogue ===
#speaker:adam
О, Леклер! Ты уже здесь? Я... эээ... просто проверяю температуру духовки.
#speaker:charlie
...
=== maksim_goodbye ===
#speaker:maksim
Удачи на трассе, Леклер! Если найдешь "штурмана", передавай привет.
#speaker:charlie
Обязательно.
-> END
...
Яма у дерева.
#speaker:charlie
Ну что за идиллия, пора двигать дальше.
-> END
...
# cutscene: Intro
# speaker: storytelller
Леклер и Лео вернулись на кухню, не подозревая, что их ждет.

# cutscene: Surprise
# speaker: maksim
СЮРПРИЗ! С возвращением домой, чемпион! Великий торт уже порезан!

# cutscene: CharlieReaction
# speaker: charlie
Ребята... Вы всё это устроили? Где, черт возьми, вы нашли гигантский муляж помидора.

# cutscene: LeoHappy
# speaker: leo
ВУФ! (Лео бегает вокруг бывшего помидора)

# cutscene: Outro
# speaker: storytelller
В этот вечер Леклер понял, что даже самый быстрый гонщик нуждается в пит-стопе. А лучший приз — это не кубки, а те, кто ждет тебя на финише.
